...
public class FriendServiceImpl implements com.example.realtimechat.service.FriendService {
	...
	@Override
	public boolean sendFriendRequest(FriendRequest.FriendRequestDTO rq)
